...
class __TwigTemplate_35b07fcb82710b411d2656f52ce2592ef12e88f753fa25f90a977d1c6d7084bd extends Template
{
    private $source;
    private $macros = [];
    ...
    <hr>
    <p>
        Si la cuenta de correo existe en el sistema, recibirás un email que contiene un enlace para que puedas restaurar tu contraseña<br>
    ...
    <p>Si no recibes el email por favor, revisa la carpeta de spam o <a href=\"";
        // line 13
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_forgot_password_request");
        echo "\">intentalo de nuevo</a>.</p>
</div>
";
...
{% block title %}Email de reseteo enviado{% endblock %}
...
<div class=\"container-md pt-3\">
    ...
    <p>Si no recibes el email por favor, revisa la carpeta de spam o <a href=\"{{ path('app_forgot_password_request') }}\">intentalo de nuevo</a>.</p>
</div>
{% endblock %}
", "reset_password/check_email.html.twig", "/mnt/data/home/565124.cloudwaysapps.com/uxnuseexjv/public_html/dev/templates/reset_password/check_email.html.twig");
    }
}
